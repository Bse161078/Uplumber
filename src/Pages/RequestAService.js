...
function ProviderDetail(props) {
        ...
        (res) => {
          if (
            ...
            const postData = {
              ...
              leadPrice: localStorage.getItem("leadPrice"),
            };
  ...
  const updateCustomerProblem = () => {
    ...
    if (
      ...
      var data = {
        ...
        leadPrice:
          requestData.waterDamage === "Yes"
            ? requestData.waterDamagePrice
            : requestData.leadPrice,
      };
      ...
      for (let i = 0; i < requestData.image.length; i++) {
        try {
          ...
          const uploadResponse = await uploadImage(
            new File([blob], requestData.image[i].name)
          );
  ...
  const updateCustomerContactDetails = async () => {
    debugger;
    if (
      (requestData.userName != "" && requestData.userPhone) ||
      ...
      var data = {
        ...
        leadPrice:
          requestData?.waterDamage === "Yes"
            ? requestData.waterDamagePrice
            : requestData.leadPricerequestData?.waterDamage === "Yes"
            ? requestData.waterDamagePrice
            : requestData.leadPrice,
      };
      ...
      debugger;
      const postData = {
        serviceId: localStorage.getItem("requestId"),
        leadPrice:
          requestData?.waterDamage === "Yes"
            ? requestData.waterDamagePrice
            : requestData.leadPrice,
