...
import {
    MyProfile, UpdateCustomerProfile
    , deleteProfileApi,
            ...
            >
                ...
                {deleteProfile && <Alert severity="error" style={{ margin: 0 }} >
                    ...
                    <button
                        ...
                        style={{
                            width: "30%", height: 30, background: "red", color: 'white', border: "none",
                    ...
                    <button
                        ...
                        style={{
                            width: "30%", height: 30, margin: 20, background: "#1075c2", color: 'white', border: "none",
                            borderRadius: 15, cursor: 'pointer'
                        }}
                        onClick={() => {
