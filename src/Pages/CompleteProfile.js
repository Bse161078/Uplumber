...
function LoginPage(props) {
    ...
    const user = Object.assign(
        {},
        JSON.parse(localStorage.getItem("emailForSignIn"))
    );
    ...
    const [lastName, setLastName] = useState(
        localStorage.getItem("lastName") ? localStorage.getItem("lastName") : lName
    );
        ...
        /> */}
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        localStorage.setItem(
                            "userCity",
                            address?.userCity ? address.userCity : e.target.value
                        );
                    }}
                ></input>
                <p className={classes.label} style={{ marginTop: 10 }}>
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        localStorage.setItem(
                            "userState",
                            address?.userState ? address.userState : e.target.value
                        );
                    }}
                />
                ...
                <input
                    ...
                    onChange={(e) => {
                        ...
                        localStorage.setItem(
                            "userZipcode",
                            address?.userZipCode ? address.userZipCode : e.target.value
                        );
                    }}
                ></input>
